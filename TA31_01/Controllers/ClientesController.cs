...
using TA31_01.Modelo;

namespace TA31_01.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        public async Task<ActionResult<Cliente>> PostCliente(Cliente cliente)
        {
          if (_context.ClienteItems == null)
          {
              return Problem("Entity set 'ClienteContext.ClienteItems'  is null.");
          }
        ...
        {
            return (_context.ClienteItems?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
